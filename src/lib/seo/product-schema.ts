...
export function generateSoftwareApplicationSchema(
  ...
  const baseUrl = resolveAppUrl(siteSettings, params.appUrl);
...
export const SaasProductPresets = {
  ...
  taskManagement: {
    name: "智能任务管理系统",
    description: "功能强大的任务管理平台，支持团队协作、进度跟踪、数据分析等核心功能。提高团队效率30%以上。",
  ...
  cloudStorage: {
    name: "企业云存储服务",
    description: "安全可靠的云存储解决方案，提供文件同步、团队协作、权限管理等功能。",
  ...
  crm: {
    name: "客户关系管理系统",
    description: "全面的CRM解决方案，帮助企业管理客户关系、销售流程和客户服务。",
