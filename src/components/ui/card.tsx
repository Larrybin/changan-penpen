...
function Card({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            data-slot="card"
            className={cn(
                "bg-card text-card-foreground flex flex-col gap-[var(--card-gap)] rounded-[var(--card-radius)] border py-[var(--card-py)] shadow-sm",
                className,
            )}
            {...props}
        />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            className={cn("flex items-center px-[var(--card-footer-px)] [.border-t]:pt-[var(--card-footer-pt)]", className)}
            {...props}
        />
    );
}
