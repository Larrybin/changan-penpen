...
export function ImageOptimizer({
    ...
    if (!decorative && !alt.trim()) {
        console.warn("ImageOptimizer: alt文本不能为空，请提供描述性的alt属性", {
            src,
        });
    }
...
export function HeroImage(
    props: Omit<ImageOptimizerProps, "sizes" | "priority">,
) {
...
export function DecorativeImage(
    props: Omit<ImageOptimizerProps, "alt" | "decorative">,
) {
    return <ImageOptimizer {...props} alt="" decorative />;
}
