                ...
                <Card className="lg:col-span-1">
                    ...
                    <CardContent>
                        <div className="flex flex-col items-center space-y-2">
                            ...
                            <Badge className="bg-green-50 text-green-600">优秀</Badge>
            ...
            <Tabs defaultValue="scan" className="space-y-4">
                ...
                <TabsContent value="scan" className="space-y-4">
                    <div className="flex items-center justify-between">
                        <h3 className="text-lg font-semibold">实时SEO扫描</h3>
                                ...
                                {[
                                    {
                                        ...
                                        url: '/about',
                                        impact: '中',
                                        description: '标题长度建议在30-60字符之间'
                                    },
                                    {
                                        title: '缺少Open Graph标签',
                                        url: '/products',
                                        impact: '中',
                                        description: '添加og:title和og:description标签'
                                    }
                                ].map((issue, index) => (
                                ...
                                {[
                                    {
                                        priority: 1,
                                        title: '完善Meta标签',
                                        description: '为所有页面添加完整的Meta描述和关键词标签',
                                        impact: '高',
                                        effort: '低',
                                        timeframe: '1-2天'
                                    },
                                    {
                                        priority: 2,
                                        title: '优化标题结构',
                                        description: '确保每个页面只有一个H1标签，标题层次清晰',
                                        impact: '高',
                                        effort: '中',
                                        timeframe: '3-5天'
                                    },
                                    {
                                        priority: 3,
                                        title: '添加结构化数据',
                                        description: '为产品页面添加Product schema，为文章添加Article schema',
                                        impact: '中',
                                        effort: '高',
                                        timeframe: '1-2周'
                                    }
                                    ...
                                    <div key={index} className="flex items-start space-x-4 p-4 border rounded-lg">
                                        ...
                                        <div className="flex-1 space-y-2">
                                            ...
                                            <div className="flex items-center space-x-4">
                                                <Badge variant="outline">影响: {rec.impact}</Badge>
                                                <Badge variant="outline">工作量: {rec.effort}</Badge>
                                                <Badge variant="outline">时间: {rec.timeframe}</Badge>
                                            </div>
                                        </div>
                                    </div>
                                ))}
